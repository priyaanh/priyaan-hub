...
| 💬 Spanish Practice | `spanish.html` | Endless Spanish, asked and marked on the page: regular present tense, ser vs estar, stem changers, tener, ir and the al/del contractions, gustar, articles and agreement, question words, numbers, telling time, and vocabulary both ways. A round is an ordinary seeded worksheet asked one question at a time, so when it runs out another starts. Accents are not needed to be marked right, and there are accent keys for a keyboard without them. A printable set is offered as an extra. |
| 🔬 Science | `science.js`, asked in `ask.html` | Twelve topics for grades 4 to 8: moon phases, the solar system, seasons, states of matter, the water cycle, energy, forces and motion, cells, food chains, atoms and mixtures, light and sound, and rocks. Each question carries its own options, because the wrong answers to "which phase comes next" have to be other phases. |
