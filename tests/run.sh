...
for page in index piano badges math spanish ask books quizzes hindi schedule calendar ai python progress review profile; do
...
want=("$@"); [ ${#want[@]} -eq 0 ] && want=(hub search progress review theme profile name dates free ai gradesheet spanish ask books python tasks sched quizprint cal badges hindicards pianolog a11y mobile buttons metronome contrast contrast-dark contrast-midnight contrast-paper contrast-contrast contrast-slate contrast-ink contrast-dusk contrast-forest hostile offline)
