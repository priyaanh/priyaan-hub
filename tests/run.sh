...
want=("$@"); [ ${#want[@]} -eq 0 ] && want=(hub search progress review theme profile name dates free ai gradesheet spanish ask books python tasks sched quizprint cal badges hindicards pianolog a11y mobile metronome contrast contrast-dark contrast-midnight contrast-paper contrast-contrast contrast-slate contrast-ink contrast-dusk contrast-forest hostile offline)
