...
want=("$@"); [ ${#want[@]} -eq 0 ] && want=(hub dates free ai gradesheet python tasks sched quizprint cal badges hindicards pianolog a11y mobile metronome contrast contrast-dark hostile offline)
...
for gen in test_im1.js test_grades.js test_pyquiz.js; do
